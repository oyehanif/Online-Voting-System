...
public class OTP_Authentication extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verificationclick = findViewById(R.id.otpverify);
        ...
        final ProgressBar progressBarverify = findViewById(R.id.progressbar_verfiy_otp);
            ...
            public void onClick(View v) {
                if (!inputnumber1.getText().toString().trim().isEmpty() && !inputnumber2.getText().toString().trim().isEmpty() && !inputnumber3.getText().toString().trim().isEmpty() && !inputnumber4.getText().toString().trim().isEmpty() && !inputnumber5.getText().toString().trim().isEmpty() && !inputnumber6.getText().toString().trim().isEmpty()) {
                    ...
                    if (getotpbackend != null) {
                                ...
                                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        ...
                                        if (task.isSuccessful()) {
                                            Intent intent = new Intent(getApplicationContext(), VotingScreen.class);
                        ...
                        Toast.makeText(OTP_Authentication.this, "Please Chake Internet Connection", Toast.LENGTH_SHORT).show();
                    }

                    //  Toast.makeText(OTP_Verification.this, "OTP VERIFY", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(OTP_Authentication.this, "ENTER ALL NUMBER", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        TextView resendlabel = findViewById(R.id.inputresendotp);
