...
//                         startActivity(intent);
                        ...
                        Toast.makeText(PhoneAuthentication.this, "Pleas Enter Correct Number!", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(PhoneAuthentication.this, "Enter Mobile Number", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
